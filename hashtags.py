...
fashion = ['#styleinspo', '#ootd', '#outfitoftheday', '#whatiwore', '#shoppingaddict', '#beautydoesnthavetobepain', '#currentlywearing', '#instastyle', '#lookgoodfeelgood']

food = ['#instafood', '#omnomnom', '#foodporn', '#food', '#foodie', '#organic', '#healthyeats', '#goodeats', '#vegetarian', '#vegan', '#glutenfree', '#hungry', '#homemade', '#madefromscratch']

travel = ['#travel', '#staycation', '#vacation', '#sunsout', '#resortwear', '#tourist', '#travelbug', '#solotravel', '#honeymoon', '#traveltuesday', '#wanderlust', '#wanderlustwednesday', '#travelgram', '#sun']

pet = ['#puppylove', '#mansbestfriend', '#womansbestfriend', '#catsofinstagram', '#dogsofinstagram', '#dogstagram', '#doglife', '#catlife', '#instapet']
